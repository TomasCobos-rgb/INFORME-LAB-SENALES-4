...
### CONCLUSIONES 
- El filtrado digital aplicado a la señal EMG permitió eliminar eficazmente el ruido y las variaciones de baja frecuencia, resaltando la actividad eléctrica real del músculo durante las contracciones. Esto se evidencia en la comparación entre la señal original y la filtrada, así como en la clara identificación de los segmentos correspondientes a las 83 contracciones analizadas.
